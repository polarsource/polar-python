...
class Advertisements(BaseSDK):
    ...
    def list(
        ...
        sorting: OptionalNullable[List[models.AdvertisementSortProperty]] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.AdvertisementsListResponse:
        r"""List Campaigns
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.AdvertisementsListResponse(result=utils.unmarshal_json(http_res.text, Optional[models.AdvertisementCampaignListResource]), next=next_func)

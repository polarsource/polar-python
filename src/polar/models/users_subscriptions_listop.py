...
class UsersSubscriptionsListRequestTypedDict(TypedDict):
    organization_id: NotRequired[Nullable[UsersSubscriptionsListQueryParamOrganizationIDFilterTypedDict]]
    r"""Filter by organization ID."""
...
class UsersSubscriptionsListRequest(BaseModel):
    organization_id: Annotated[OptionalNullable[UsersSubscriptionsListQueryParamOrganizationIDFilter], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Filter by organization ID."""

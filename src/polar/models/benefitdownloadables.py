...
class BenefitDownloadablesType(str, Enum):
...
class BenefitDownloadables(BaseModel):
    ...
    TYPE: Annotated[Final[BenefitDownloadablesType], pydantic.Field(alias="type")] = BenefitDownloadablesType.DOWNLOADABLES # type: ignore

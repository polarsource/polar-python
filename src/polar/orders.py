...
class Orders(BaseSDK):
    ...
    def list(
        self, *,
        organization_id: OptionalNullable[Union[models.OrdersListQueryParamOrganizationIDFilter, models.OrdersListQueryParamOrganizationIDFilterTypedDict]] = UNSET,
        product_id: OptionalNullable[Union[models.OrdersListQueryParamProductIDFilter, models.OrdersListQueryParamProductIDFilterTypedDict]] = UNSET,
        product_price_type: OptionalNullable[Union[models.QueryParamProductPriceTypeFilter, models.QueryParamProductPriceTypeFilterTypedDict]] = UNSET,
        user_id: OptionalNullable[Union[models.UserIDFilter, models.UserIDFilterTypedDict]] = UNSET,
        page: Optional[int] = 1,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.OrdersListResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListResourceOrder]), next=next_func)

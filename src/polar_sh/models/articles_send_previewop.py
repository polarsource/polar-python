...
class ArticlesSendPreviewSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class ArticlesSendPreviewSecurity(BaseModel):
...
class ArticlesSendPreviewRequestTypedDict(TypedDict):
    id: str
    article_preview: ArticlePreviewTypedDict
    

class ArticlesSendPreviewRequest(BaseModel):

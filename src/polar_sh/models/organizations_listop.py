...
class OrganizationsListSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class OrganizationsListSecurity(BaseModel):
...
OrganizationsListQueryParamSortingTypedDict = Union[List[Any], str]
...
OrganizationsListQueryParamSorting = Union[List[Any], str]
r"""Sorting criterion. Several criteria can be used simultaneously and will be applied in order. Add a minus sign `-` before the criteria name to sort by descending order."""
...
class OrganizationsListRequestTypedDict(TypedDict):
    ...
    sorting: NotRequired[Nullable[OrganizationsListQueryParamSortingTypedDict]]
    r"""Sorting criterion. Several criteria can be used simultaneously and will be applied in order. Add a minus sign `-` before the criteria name to sort by descending order."""
...
class OrganizationsListRequest(BaseModel):
    ...
    r"""Filter by slug."""
    is_member: Annotated[OptionalNullable[bool], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Filter by membership. If `true`, only organizations the user is a member of are returned. If `false`, only organizations the user is not a member of are returned."""
    ...
    r"""Size of a page, defaults to 10. Maximum is 100."""
    sorting: Annotated[OptionalNullable[OrganizationsListQueryParamSorting], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Sorting criterion. Several criteria can be used simultaneously and will be applied in order. Add a minus sign `-` before the criteria name to sort by descending order."""

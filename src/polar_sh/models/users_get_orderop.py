...
class UsersGetOrderSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class UsersGetOrderSecurity(BaseModel):
...
class UsersGetOrderRequestTypedDict(TypedDict):
    id: str
    r"""The order ID."""
    

class UsersGetOrderRequest(BaseModel):

...
class AccountsDashboardLinkSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class AccountsDashboardLinkSecurity(BaseModel):
...
class AccountsDashboardLinkRequestTypedDict(TypedDict):
    id: str
    

class AccountsDashboardLinkRequest(BaseModel):

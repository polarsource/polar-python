...
class OrdersListSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class OrdersListSecurity(BaseModel):
...
QueryParamProductPriceTypeFilterTypedDict = Union[ProductPriceType, List[ProductPriceType]]
...
OrdersListQueryParamSortingTypedDict = Union[List[Any], str]
...
OrdersListQueryParamSorting = Union[List[Any], str]
r"""Sorting criterion. Several criteria can be used simultaneously and will be applied in order. Add a minus sign `-` before the criteria name to sort by descending order."""


class OrdersListRequestTypedDict(TypedDict):
    organization_id: NotRequired[Nullable[OrdersListQueryParamOrganizationIDFilterTypedDict]]
    r"""Filter by organization ID."""
    ...
    sorting: NotRequired[Nullable[OrdersListQueryParamSortingTypedDict]]
    r"""Sorting criterion. Several criteria can be used simultaneously and will be applied in order. Add a minus sign `-` before the criteria name to sort by descending order."""
    

class OrdersListRequest(BaseModel):
    organization_id: Annotated[OptionalNullable[OrdersListQueryParamOrganizationIDFilter], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Filter by organization ID."""
    product_id: Annotated[OptionalNullable[OrdersListQueryParamProductIDFilter], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Filter by product ID."""
    product_price_type: Annotated[OptionalNullable[QueryParamProductPriceTypeFilter], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Filter by product price type. `recurring` will return orders corresponding to subscriptions creations or renewals. `one_time` will return orders corresponding to one-time purchases."""
    user_id: Annotated[OptionalNullable[UserIDFilter], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Filter by customer's user ID."""
    ...
    r"""Size of a page, defaults to 10. Maximum is 100."""
    sorting: Annotated[OptionalNullable[OrdersListQueryParamSorting], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Sorting criterion. Several criteria can be used simultaneously and will be applied in order. Add a minus sign `-` before the criteria name to sort by descending order."""
    
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = ["organization_id", "product_id", "product_price_type", "user_id", "page", "limit", "sorting"]
        nullable_fields = ["organization_id", "product_id", "product_price_type", "user_id", "sorting"]
        null_default_fields = []

...
class UsersGetOrderInvoiceSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class UsersGetOrderInvoiceSecurity(BaseModel):
...
class UsersGetOrderInvoiceRequestTypedDict(TypedDict):
    id: str
    r"""The order ID."""
    

class UsersGetOrderInvoiceRequest(BaseModel):

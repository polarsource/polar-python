...
class AuthorizeResponseOrganization(BaseModel):
    ...
    SUB_TYPE: Annotated[Final[AuthorizeResponseOrganizationSubType], pydantic.Field(alias="sub_type")] = AuthorizeResponseOrganizationSubType.ORGANIZATION # type: ignore

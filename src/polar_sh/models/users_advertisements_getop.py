...
class UsersAdvertisementsGetSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class UsersAdvertisementsGetSecurity(BaseModel):
...
class UsersAdvertisementsGetRequestTypedDict(TypedDict):
    id: str
    r"""The advertisement campaign ID."""
    

class UsersAdvertisementsGetRequest(BaseModel):

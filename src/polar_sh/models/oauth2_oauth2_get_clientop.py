...
class Oauth2Oauth2GetClientSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class Oauth2Oauth2GetClientSecurity(BaseModel):
...
class Oauth2Oauth2GetClientRequestTypedDict(TypedDict):
    client_id: str
    

class Oauth2Oauth2GetClientRequest(BaseModel):

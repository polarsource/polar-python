...
class ArticlesGetReceiversSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class ArticlesGetReceiversSecurity(BaseModel):
...
class ArticlesGetReceiversRequestTypedDict(TypedDict):
    id: str
    

class ArticlesGetReceiversRequest(BaseModel):

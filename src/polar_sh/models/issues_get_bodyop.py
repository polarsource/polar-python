...
class IssuesGetBodySecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class IssuesGetBodySecurity(BaseModel):
...
class IssuesGetBodyRequestTypedDict(TypedDict):
    id: str
    

class IssuesGetBodyRequest(BaseModel):

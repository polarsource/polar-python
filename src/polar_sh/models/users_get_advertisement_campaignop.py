...
class UsersGetAdvertisementCampaignSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class UsersGetAdvertisementCampaignSecurity(BaseModel):
...
class UsersGetAdvertisementCampaignRequestTypedDict(TypedDict):
    id: str
    r"""The advertisement campaign ID."""
    

class UsersGetAdvertisementCampaignRequest(BaseModel):

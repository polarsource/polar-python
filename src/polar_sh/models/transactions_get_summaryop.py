...
class TransactionsGetSummarySecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class TransactionsGetSummarySecurity(BaseModel):
...
class TransactionsGetSummaryRequestTypedDict(TypedDict):
    account_id: str
    

class TransactionsGetSummaryRequest(BaseModel):

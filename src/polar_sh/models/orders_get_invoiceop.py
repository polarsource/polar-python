...
class OrdersGetInvoiceSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class OrdersGetInvoiceSecurity(BaseModel):
...
class OrdersGetInvoiceRequestTypedDict(TypedDict):
    id: str
    r"""The order ID."""
    

class OrdersGetInvoiceRequest(BaseModel):

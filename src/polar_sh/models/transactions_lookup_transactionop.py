...
class TransactionsLookupTransactionSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class TransactionsLookupTransactionSecurity(BaseModel):
...
class TransactionsLookupTransactionRequestTypedDict(TypedDict):
    transaction_id: str
    

class TransactionsLookupTransactionRequest(BaseModel):
    transaction_id: Annotated[str, FieldMetadata(query=QueryParamMetadata(style="form", explode=True))]

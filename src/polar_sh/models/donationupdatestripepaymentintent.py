...
class DonationUpdateStripePaymentIntentSetupFutureUsage(str, Enum):
    ON_SESSION = "on_session"

class DonationUpdateStripePaymentIntentTypedDict(TypedDict):
    email: str
...
class DonationUpdateStripePaymentIntent(BaseModel):
    email: str
    r"""The donators email address. Receipts will be sent to this address."""
    amount: int
    r"""The amount in cents."""
    ...
    r"""The currency. Currently, only `usd` is supported."""
    SETUP_FUTURE_USAGE: Annotated[Final[OptionalNullable[DonationUpdateStripePaymentIntentSetupFutureUsage]], pydantic.Field(alias="setup_future_usage")] = DonationUpdateStripePaymentIntentSetupFutureUsage.ON_SESSION # type: ignore

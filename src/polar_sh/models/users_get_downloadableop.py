...
class UsersGetDownloadableSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class UsersGetDownloadableSecurity(BaseModel):
...
class UsersGetDownloadableRequestTypedDict(TypedDict):
    token: str
    

class UsersGetDownloadableRequest(BaseModel):

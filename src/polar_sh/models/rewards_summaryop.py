...
class RewardsSummarySecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class RewardsSummarySecurity(BaseModel):
...
class RewardsSummaryRequestTypedDict(TypedDict):
    issue_id: str
    

class RewardsSummaryRequest(BaseModel):
    issue_id: Annotated[str, FieldMetadata(query=QueryParamMetadata(style="form", explode=True))]

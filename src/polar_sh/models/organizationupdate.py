...
class OrganizationUpdate(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["name", "avatar_url", "default_upfront_split_to_contributors", "pledge_badge_show_amount", "billing_email", "default_badge_custom_content", "pledge_minimum_amount", "total_monthly_spending_limit", "per_user_monthly_spending_limit", "donations_enabled", "profile_settings", "feature_settings"]
        nullable_fields = ["name", "avatar_url", "default_upfront_split_to_contributors", "billing_email", "default_badge_custom_content", "total_monthly_spending_limit", "per_user_monthly_spending_limit", "profile_settings", "feature_settings"]
        null_default_fields = []

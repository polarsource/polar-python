...
class MetricsGetSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class MetricsGetSecurity(BaseModel):
...
MetricsGetQueryParamProductPriceTypeFilterTypedDict = Union[ProductPriceType, List[ProductPriceType]]
...
MetricsGetQueryParamProductPriceTypeFilter = Union[ProductPriceType, List[ProductPriceType]]
r"""Filter by product price type. `recurring` will filter data corresponding to subscriptions creations or renewals. `one_time` will filter data corresponding to one-time purchases."""
...
class MetricsGetRequestTypedDict(TypedDict):
    ...
    interval: Interval
    r"""Interval between two timestamps."""
    organization_id: NotRequired[Nullable[MetricsGetQueryParamOrganizationIDFilterTypedDict]]
    r"""Filter by organization ID."""
    product_id: NotRequired[Nullable[MetricsGetQueryParamProductIDFilterTypedDict]]
    r"""Filter by product ID."""
    product_price_type: NotRequired[Nullable[MetricsGetQueryParamProductPriceTypeFilterTypedDict]]
    r"""Filter by product price type. `recurring` will filter data corresponding to subscriptions creations or renewals. `one_time` will filter data corresponding to one-time purchases."""
...
class MetricsGetRequest(BaseModel):
    ...
    r"""End date."""
    interval: Annotated[Interval, FieldMetadata(query=QueryParamMetadata(style="form", explode=True))]
    r"""Interval between two timestamps."""
    organization_id: Annotated[OptionalNullable[MetricsGetQueryParamOrganizationIDFilter], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Filter by organization ID."""
    product_id: Annotated[OptionalNullable[MetricsGetQueryParamProductIDFilter], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Filter by product ID."""
    product_price_type: Annotated[OptionalNullable[MetricsGetQueryParamProductPriceTypeFilter], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Filter by product price type. `recurring` will filter data corresponding to subscriptions creations or renewals. `one_time` will filter data corresponding to one-time purchases."""

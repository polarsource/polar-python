...
UsersListAdvertisementCampaignsQueryParamSortingTypedDict = Union[List[Any], str]
...
UsersListAdvertisementCampaignsQueryParamSorting = Union[List[Any], str]
r"""Sorting criterion. Several criteria can be used simultaneously and will be applied in order. Add a minus sign `-` before the criteria name to sort by descending order."""
...
class UsersListAdvertisementCampaignsRequestTypedDict(TypedDict):
    ...
    sorting: NotRequired[Nullable[UsersListAdvertisementCampaignsQueryParamSortingTypedDict]]
    r"""Sorting criterion. Several criteria can be used simultaneously and will be applied in order. Add a minus sign `-` before the criteria name to sort by descending order."""
...
class UsersListAdvertisementCampaignsRequest(BaseModel):
    ...
    r"""Size of a page, defaults to 10. Maximum is 100."""
    sorting: Annotated[OptionalNullable[UsersListAdvertisementCampaignsQueryParamSorting], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Sorting criterion. Several criteria can be used simultaneously and will be applied in order. Add a minus sign `-` before the criteria name to sort by descending order."""

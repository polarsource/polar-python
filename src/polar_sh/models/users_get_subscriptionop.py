...
class UsersGetSubscriptionSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class UsersGetSubscriptionSecurity(BaseModel):
...
class UsersGetSubscriptionRequestTypedDict(TypedDict):
    id: str
    r"""The subscription ID."""
    

class UsersGetSubscriptionRequest(BaseModel):

...
class UsersDeleteAdvertisementCampaignSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class UsersDeleteAdvertisementCampaignSecurity(BaseModel):
...
class UsersDeleteAdvertisementCampaignRequestTypedDict(TypedDict):
    id: str
    r"""The advertisement campaign ID."""
    

class UsersDeleteAdvertisementCampaignRequest(BaseModel):

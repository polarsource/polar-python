...
from .updateissue import UpdateIssue, UpdateIssueTypedDict
...
class IssuesUpdateSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class IssuesUpdateSecurity(BaseModel):
...
class IssuesUpdateRequestTypedDict(TypedDict):
    id: str
    update_issue: UpdateIssueTypedDict
    

class IssuesUpdateRequest(BaseModel):
    id: Annotated[str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))]
    update_issue: Annotated[UpdateIssue, FieldMetadata(request=RequestMetadata(media_type="application/json"))]

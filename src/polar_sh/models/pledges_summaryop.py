...
class PledgesSummarySecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class PledgesSummarySecurity(BaseModel):
...
class PledgesSummaryRequestTypedDict(TypedDict):
    issue_id: str
    

class PledgesSummaryRequest(BaseModel):

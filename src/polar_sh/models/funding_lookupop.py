...
class FundingLookupSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class FundingLookupSecurity(BaseModel):
...
class FundingLookupRequestTypedDict(TypedDict):
    issue_id: str
    

class FundingLookupRequest(BaseModel):

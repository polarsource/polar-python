...
class UsersListSubscriptionsSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class UsersListSubscriptionsSecurity(BaseModel):
...
UsersListSubscriptionsQueryParamOrganizationIDFilterTypedDict = Union[str, List[str]]
r"""Filter by organization ID."""


UsersListSubscriptionsQueryParamOrganizationIDFilter = Union[str, List[str]]
r"""Filter by organization ID."""
...
UsersListSubscriptionsQueryParamSortingTypedDict = Union[List[Any], str]
...
UsersListSubscriptionsQueryParamSorting = Union[List[Any], str]
r"""Sorting criterion. Several criteria can be used simultaneously and will be applied in order. Add a minus sign `-` before the criteria name to sort by descending order."""


class UsersListSubscriptionsRequestTypedDict(TypedDict):
    organization_id: NotRequired[Nullable[UsersListSubscriptionsQueryParamOrganizationIDFilterTypedDict]]
    r"""Filter by organization ID."""
    ...
    sorting: NotRequired[Nullable[UsersListSubscriptionsQueryParamSortingTypedDict]]
    r"""Sorting criterion. Several criteria can be used simultaneously and will be applied in order. Add a minus sign `-` before the criteria name to sort by descending order."""
    

class UsersListSubscriptionsRequest(BaseModel):
    organization_id: Annotated[OptionalNullable[UsersListSubscriptionsQueryParamOrganizationIDFilter], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Filter by organization ID."""
    product_id: Annotated[OptionalNullable[QueryParamProductIDFilter], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Filter by product ID."""
    ...
    r"""Size of a page, defaults to 10. Maximum is 100."""
    sorting: Annotated[OptionalNullable[UsersListSubscriptionsQueryParamSorting], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Sorting criterion. Several criteria can be used simultaneously and will be applied in order. Add a minus sign `-` before the criteria name to sort by descending order."""
    
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = ["organization_id", "product_id", "active", "query", "page", "limit", "sorting"]
        nullable_fields = ["organization_id", "product_id", "active", "query", "sorting"]
        null_default_fields = []

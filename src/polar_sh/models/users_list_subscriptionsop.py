...
class UsersListSubscriptionsRequest(BaseModel):
    ...
    r"""Size of a page, defaults to 10. Maximum is 100."""
    sorting: Annotated[OptionalNullable[List[UserSubscriptionSortProperty]], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Sorting criterion. Several criteria can be used simultaneously and will be applied in order. Add a minus sign `-` before the criteria name to sort by descending order."""
...
class UsersListSubscriptionsResponseTypedDict(TypedDict):
    result: ListResourceUserSubscriptionTypedDict
    

class UsersListSubscriptionsResponse(BaseModel):
    next: Callable[[], Optional[UsersListSubscriptionsResponse]]

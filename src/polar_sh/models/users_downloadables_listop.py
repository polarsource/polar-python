...
class UsersDownloadablesListSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class UsersDownloadablesListSecurity(BaseModel):
...
class UsersDownloadablesListRequestTypedDict(TypedDict):
    organization_id: NotRequired[Nullable[UsersDownloadablesListQueryParamOrganizationIDFilterTypedDict]]
    r"""Filter by organization ID."""
...
class UsersDownloadablesListRequest(BaseModel):
    organization_id: Annotated[OptionalNullable[UsersDownloadablesListQueryParamOrganizationIDFilter], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Filter by organization ID."""
...
class UsersDownloadablesListResponseTypedDict(TypedDict):
    result: ListResourceDownloadableReadTypedDict
    

class UsersDownloadablesListResponse(BaseModel):
    next: Callable[[], Optional[UsersDownloadablesListResponse]]

...
class UsersCancelSubscriptionSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class UsersCancelSubscriptionSecurity(BaseModel):
...
class UsersCancelSubscriptionRequestTypedDict(TypedDict):
    id: str
    r"""The subscription ID."""
    

class UsersCancelSubscriptionRequest(BaseModel):

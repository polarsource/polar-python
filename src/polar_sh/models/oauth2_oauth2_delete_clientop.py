...
class Oauth2Oauth2DeleteClientSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class Oauth2Oauth2DeleteClientSecurity(BaseModel):
...
class Oauth2Oauth2DeleteClientRequestTypedDict(TypedDict):
    client_id: str
    

class Oauth2Oauth2DeleteClientRequest(BaseModel):

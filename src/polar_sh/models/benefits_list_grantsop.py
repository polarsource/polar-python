...
class BenefitsListGrantsSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class BenefitsListGrantsSecurity(BaseModel):
...
class BenefitsListGrantsRequestTypedDict(TypedDict):
    id: str
...
class BenefitsListGrantsRequest(BaseModel):
...
class BenefitsListGrantsResponseTypedDict(TypedDict):
    result: ListResourceBenefitGrantTypedDict
    

class BenefitsListGrantsResponse(BaseModel):
    next: Callable[[], Optional[BenefitsListGrantsResponse]]

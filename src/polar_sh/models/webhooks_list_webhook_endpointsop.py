...
class WebhooksListWebhookEndpointsSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class WebhooksListWebhookEndpointsSecurity(BaseModel):
...
class WebhooksListWebhookEndpointsRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["organization_id", "user_id", "page", "limit"]
        nullable_fields = ["organization_id", "user_id"]
        null_default_fields = []

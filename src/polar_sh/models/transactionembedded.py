...
class TransactionEmbeddedTypedDict(TypedDict):
    created_at: datetime
...
class TransactionEmbedded(BaseModel):
    created_at: datetime
    r"""Creation timestamp of the object."""
    modified_at: Nullable[datetime]
    r"""Last modification timestamp of the object."""
    ...
    def serialize_model(self, handler):
        optional_fields = []
        nullable_fields = ["modified_at", "processor", "platform_fee_type", "pledge_id", "issue_reward_id", "order_id", "donation_id", "payout_transaction_id", "incurred_by_transaction_id"]
        null_default_fields = []

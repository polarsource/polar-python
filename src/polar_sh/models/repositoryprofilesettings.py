...
class RepositoryProfileSettings(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["description", "cover_image_url", "featured_organizations", "highlighted_subscription_tiers", "links"]
        nullable_fields = ["description", "cover_image_url", "featured_organizations", "highlighted_subscription_tiers", "links"]
        null_default_fields = []

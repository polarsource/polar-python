...
class AccountsSearchSecurityTypedDict(TypedDict):
    open_id_connect: NotRequired[str]
    http_bearer: NotRequired[str]
    

class AccountsSearchSecurity(BaseModel):
...
class AccountsSearchRequestTypedDict(TypedDict):
...
class AccountsSearchRequest(BaseModel):

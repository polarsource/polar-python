...
class Organizations(BaseSDK):
    ...
    def list(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.OrganizationsListResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListResourceOrganization]), next=next_func)
    ...
    def organizations_list_organization_customers(
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.OrganizationsListOrganizationCustomersResponse:
        ...
        def next_func() -> Optional[models.OrganizationsListOrganizationCustomersResponse]:
            body = utils.unmarshal_json(http_res.text, Dict[Any, Any])
            page = request.page if not request.page is None else 0
            next_page = page + 1
            ...
            return self.organizations_list_organization_customers(
                security=security,
                id=id,
                customer_types=customer_types,
                page=next_page,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.OrganizationsListOrganizationCustomersResponse(result=utils.unmarshal_json(http_res.text, Optional[models.ListResourceOrganizationCustomer]), next=next_func)
        if utils.match_response(http_res, "404", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ResourceNotFoundData)
            raise models.ResourceNotFound(data=data)
        if utils.match_response(http_res, "422", "application/json"):

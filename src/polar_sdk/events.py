...
class Events(BaseSDK):
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.EventsListResponse(
                result=utils.unmarshal_json_response(
                    models.ListResourceEvent, http_res
                ),
                next=next_func,
            )
        ...
        **Scopes**: `events:read` `events:write`
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.EventsListNamesResponse(
                result=utils.unmarshal_json_response(
                    models.ListResourceEventName, http_res
                ),
                next=next_func,
            )
        if utils.match_response(http_res, "422", "application/json"):
    ...
    def get(
        ...
        **Scopes**: `events:read` `events:write`
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(models.Event, http_res)
    ...
    def ingest(
        ...
        **Scopes**: `events:write`
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(models.EventsIngestResponse, http_res)
        if utils.match_response(http_res, "422", "application/json"):
            response_data = utils.unmarshal_json_response(
                models.HTTPValidationErrorData, http_res
            )

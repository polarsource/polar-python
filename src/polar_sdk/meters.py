...
class Meters(BaseSDK):
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.MetersListResponse(
                result=utils.unmarshal_json_response(
                    models.ListResourceMeter, http_res
                ),
                next=next_func,
            )
    ...
    def create(
        ...
        **Scopes**: `meters:write`
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json_response(models.Meter, http_res)
        if utils.match_response(http_res, "422", "application/json"):
            response_data = utils.unmarshal_json_response(
                models.HTTPValidationErrorData, http_res
            )
    ...
    def quantities(
        ...
        **Scopes**: `meters:read` `meters:write`
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(models.MeterQuantities, http_res)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json_response(
                models.ResourceNotFoundData, http_res
            )

...
class Orders(BaseSDK):
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.OrdersListResponse(
                result=utils.unmarshal_json_response(
                    models.ListResourceOrder, http_res
                ),
                next=next_func,
            )
    ...
    def get(
        ...
        **Scopes**: `orders:read`
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(models.Order, http_res)
    ...
    def invoice(
        ...
        **Scopes**: `orders:read`
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(models.OrderInvoice, http_res)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json_response(
                models.ResourceNotFoundData, http_res
            )

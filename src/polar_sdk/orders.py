...
class Orders(BaseSDK):
    def list(
        ...
        *,
        ...
        status: OptionalNullable[
            Union[
                models.OrdersListQueryParamStatusFilter,
                models.OrdersListQueryParamStatusFilterTypedDict,
            ]
        ] = UNSET,
        ...
        **Scopes**: `orders:read`
        ...
        :param created_after: Only include orders created after this date
        :param created_before: Only include orders created before this date
    ...
    def export(
        ...
        *,
        ...
        status: OptionalNullable[
            Union[
                models.OrdersExportQueryParamStatusFilter,
                models.OrdersExportQueryParamStatusFilterTypedDict,
            ]
        ] = UNSET,
        created_after: OptionalNullable[datetime] = UNSET,
        created_before: OptionalNullable[datetime] = UNSET,
        ...
        columns: OptionalNullable[
            Union[models.QueryParamColumns, models.QueryParamColumnsTypedDict]
        ] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        **Scopes**: `orders:read`
        ...
        :param product_id: Filter by product ID.
        :param status: Filter by order status.
        :param created_after: Only include orders created after this date. Must include a UTC offset.
        :param created_before: Only include orders created before this date. Must include a UTC offset.
        :param timezone: Time zone used to render dates in the CSV.
        :param columns: Columns to include in the CSV, in order. Defaults to email, created_at, product, net_amount, currency, status and invoice_number.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
    ...
    def generate_invoice(
        ...
        **Scopes**: `orders:read`
        ...
        if utils.match_response(http_res, "409", "application/json"):
            response_data = unmarshal_json_response(
                models.OrderNotEligibleForInvoiceData, http_res
            )
            raise models.OrderNotEligibleForInvoice(response_data, http_res)
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                models.MissingInvoiceBillingDetailsData, http_res
            )
            raise models.MissingInvoiceBillingDetails(response_data, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):

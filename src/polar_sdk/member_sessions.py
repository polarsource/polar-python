...
class MemberSessions(BaseSDK):
    def create(
        self,
        *,
        request: Union[models.MemberSessionCreate, models.MemberSessionCreateTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.MemberSession:
        r"""Create Member Session
        ...
        **Scopes**: `member_sessions:write`
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.MemberSessionCreate)
        request = cast(models.MemberSessionCreate, request)

        req = self._build_request(
            method="POST",
            path="/v1/member-sessions/",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.MemberSessionCreate
            ),
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.MemberSession, http_res)

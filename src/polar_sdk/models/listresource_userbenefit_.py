...
UserBenefitTypedDict = Union[BenefitArticlesSubscriberTypedDict, BenefitDiscordSubscriberTypedDict, BenefitGitHubRepositorySubscriberTypedDict, BenefitDownloadablesSubscriberTypedDict, BenefitAdsSubscriberTypedDict, BenefitCustomSubscriberTypedDict, BenefitLicenseKeysSubscriberTypedDict]


UserBenefit = Annotated[Union[Annotated[BenefitAdsSubscriber, Tag("ads")], Annotated[BenefitArticlesSubscriber, Tag("articles")], Annotated[BenefitCustomSubscriber, Tag("custom")], Annotated[BenefitDiscordSubscriber, Tag("discord")], Annotated[BenefitDownloadablesSubscriber, Tag("downloadables")], Annotated[BenefitGitHubRepositorySubscriber, Tag("github_repository")], Annotated[BenefitLicenseKeysSubscriber, Tag("license_keys")]], Discriminator(lambda m: get_discriminator(m, "type", "type"))]

...
CheckoutProductBenefitsTypedDict = Union[BenefitBaseTypedDict, BenefitArticlesTypedDict]


CheckoutProductBenefits = Union[BenefitBase, BenefitArticles]
...
class CheckoutProductTypedDict(TypedDict):
    ...
    benefits: List[CheckoutProductBenefitsTypedDict]
...
class CheckoutProduct(BaseModel):
    ...
    benefits: List[CheckoutProductBenefits]
    r"""List of benefits granted by the product."""
...
class CheckoutProductInputTypedDict(TypedDict):
    r"""Product data for a checkout session."""
...
class CheckoutProductInput(BaseModel):
    r"""Product data for a checkout session."""

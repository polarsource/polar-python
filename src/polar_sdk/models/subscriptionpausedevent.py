...
class SubscriptionPausedEventTypedDict(TypedDict):
    r"""An event created by Polar when a subscription is paused."""
    ...
    metadata: SubscriptionPausedMetadataTypedDict
    ...
    name: Literal["subscription.paused"]
    r"""The name of the event."""


class SubscriptionPausedEvent(BaseModel):
    r"""An event created by Polar when a subscription is paused."""

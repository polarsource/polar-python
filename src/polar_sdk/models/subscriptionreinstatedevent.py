...
class SubscriptionReinstatedEventTypedDict(TypedDict):
    r"""An event created by Polar when a canceled subscription is reinstated."""
    ...
    metadata: SubscriptionReinstatedMetadataTypedDict
    ...
    name: Literal["subscription.reinstated"]
    r"""The name of the event."""


class SubscriptionReinstatedEvent(BaseModel):
    r"""An event created by Polar when a canceled subscription is reinstated."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["subscription.reinstated"],
            AfterValidator(validate_const("subscription.reinstated")),
        ],

...
class BenefitDownloadableFileTypedDict(TypedDict):
    id: str
    ...
    downloaders: int
    r"""Number of distinct customers or members who downloaded the file."""
    downloads: int
    r"""Total number of downloads for the file."""
    size_readable: str
    service: Literal["downloadable"]


class BenefitDownloadableFile(BaseModel):
    id: str
    r"""The ID of the object."""

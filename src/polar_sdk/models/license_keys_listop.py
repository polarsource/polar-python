...
class LicenseKeysListRequestTypedDict(TypedDict):
    organization_id: NotRequired[Nullable[LicenseKeysListQueryParamOrganizationIDFilterTypedDict]]
    r"""Filter by organization ID."""
...
class LicenseKeysListRequest(BaseModel):
    organization_id: Annotated[OptionalNullable[LicenseKeysListQueryParamOrganizationIDFilter], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = UNSET
    r"""Filter by organization ID."""

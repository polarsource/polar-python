...
class ProductMediaFileReadInputService(str, Enum):
    PRODUCT_MEDIA = "product_media"


class ProductMediaFileReadInputTypedDict(TypedDict):
...
class ProductMediaFileReadInput(BaseModel):
    ...
    # fmt: off
    SERVICE: Annotated[Final[ProductMediaFileReadInputService], pydantic.Field(alias="service")] = ProductMediaFileReadInputService.PRODUCT_MEDIA # type: ignore
    # fmt: on

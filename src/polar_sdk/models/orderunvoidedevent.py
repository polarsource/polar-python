...
from .orderunvoidedmetadata import OrderUnvoidedMetadata, OrderUnvoidedMetadataTypedDict
...
class OrderUnvoidedEventTypedDict(TypedDict):
    r"""An event created by Polar when an order is unvoided."""
    ...
    metadata: OrderUnvoidedMetadataTypedDict
    ...
    name: Literal["order.unvoided"]
    r"""The name of the event."""


class OrderUnvoidedEvent(BaseModel):
    r"""An event created by Polar when an order is unvoided."""
    ...
    NAME: Annotated[
        Annotated[
            Literal["order.unvoided"], AfterValidator(validate_const("order.unvoided"))
        ],

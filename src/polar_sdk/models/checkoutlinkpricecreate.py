...
class CheckoutLinkPriceCreateTypedDict(TypedDict):
    product_price_id: str
    r"""ID of the product price to checkout."""
    metadata: NotRequired[Dict[str, CheckoutLinkPriceCreateMetadataTypedDict]]
    ...
    * A boolean
    ...
    """
    payment_processor: CheckoutLinkPriceCreatePaymentProcessor
    r"""Payment processor to use. Currently only Stripe is supported."""
...
class CheckoutLinkPriceCreate(BaseModel):
    product_price_id: str
    r"""ID of the product price to checkout."""

    metadata: Optional[Dict[str, CheckoutLinkPriceCreateMetadata]] = None
    r"""Key-value object allowing you to store additional information.
    ...
    * A boolean
    ...
    PAYMENT_PROCESSOR: Annotated[
        Annotated[
            ...
            AfterValidator(
                validate_const(CheckoutLinkPriceCreatePaymentProcessor.STRIPE)
            ),
        ],
        pydantic.Field(alias="payment_processor"),
    ] = CheckoutLinkPriceCreatePaymentProcessor.STRIPE
    r"""Payment processor to use. Currently only Stripe is supported."""

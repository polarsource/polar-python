...
from .licensekeyactivationbase import LicenseKeyActivationBase, LicenseKeyActivationBaseTypedDict
...
class ValidatedLicenseKey(BaseModel):
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = ["limit_activations", "limit_usage", "last_validated_at", "expires_at", "activation"]
        null_default_fields = []

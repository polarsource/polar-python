...
CheckoutProductsCreateMetadataTypedDict = TypeAliasType(
    "CheckoutProductsCreateMetadataTypedDict", Union[str, int, bool]
)


CheckoutProductsCreateMetadata = TypeAliasType(
    "CheckoutProductsCreateMetadata", Union[str, int, bool]
)
...
class CheckoutProductsCreateTypedDict(TypedDict):
    ...
    * A boolean
    ...
    custom_field_data: NotRequired[
        Dict[str, CheckoutProductsCreateCustomFieldDataTypedDict]
    ]
...
class CheckoutProductsCreate(BaseModel):
    ...
    * A boolean
    ...
    custom_field_data: Optional[Dict[str, CheckoutProductsCreateCustomFieldData]] = None
    r"""Key-value object storing custom field values."""

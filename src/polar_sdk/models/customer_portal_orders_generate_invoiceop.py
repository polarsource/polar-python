...
from .polar_exceptions_notpaidorder import PolarExceptionsNotPaidOrderData
...
CustomerPortalOrdersGenerateInvoiceResponse422CustomerPortalOrdersGenerateInvoiceUnion = TypeAliasType(
    ...
    Union[
        PolarExceptionsMissingInvoiceBillingDetailsData, PolarExceptionsNotPaidOrderData
    ],
)

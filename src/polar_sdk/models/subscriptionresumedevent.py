...
class SubscriptionResumedEventTypedDict(TypedDict):
    r"""An event created by Polar when a paused subscription is resumed."""
    ...
    metadata: SubscriptionResumedMetadataTypedDict
    ...
    name: Literal["subscription.resumed"]
    r"""The name of the event."""


class SubscriptionResumedEvent(BaseModel):
    r"""An event created by Polar when a paused subscription is resumed."""

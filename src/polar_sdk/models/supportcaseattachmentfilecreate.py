...
class SupportCaseAttachmentFileCreateTypedDict(TypedDict):
    r"""Schema to create a file attached to a support case."""

    name: str
    mime_type: str
    r"""MIME type of the file. Images, videos, PDF, CSV, plain text, Word and Excel documents are supported."""
    size: int
    r"""Size of the file. A maximum of 250 MB is allowed for this type of file."""
    upload: S3FileCreateMultipartTypedDict
    organization_id: NotRequired[Nullable[str]]
    checksum_sha256_base64: NotRequired[Nullable[str]]
    service: Literal["support_case_attachment"]
    version: NotRequired[Nullable[str]]


class SupportCaseAttachmentFileCreate(BaseModel):
    r"""Schema to create a file attached to a support case."""
    ...
    SERVICE: Annotated[
        Annotated[
            Literal["support_case_attachment"],
            AfterValidator(validate_const("support_case_attachment")),
        ],

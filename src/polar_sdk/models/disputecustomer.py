...
DisputeCustomerTaxIDTypedDict = TypeAliasType(
    "DisputeCustomerTaxIDTypedDict", Union[str, TaxIDFormat]
)


DisputeCustomerTaxID = TypeAliasType("DisputeCustomerTaxID", Union[str, TaxIDFormat])


class DisputeCustomerTypedDict(TypedDict):
    id: str
    ...
    tax_id: Nullable[List[Nullable[DisputeCustomerTaxIDTypedDict]]]
    organization_id: str
...
class DisputeCustomer(BaseModel):
    id: str
    r"""The ID of the customer."""
    ...
    tax_id: Nullable[List[Nullable[DisputeCustomerTaxID]]]

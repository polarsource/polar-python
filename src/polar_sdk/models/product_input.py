...
ProductInputBenefitsTypedDict = Union[BenefitBaseTypedDict, BenefitArticlesTypedDict]


ProductInputBenefits = Union[BenefitBase, BenefitArticles]
...
class ProductInputTypedDict(TypedDict):
    ...
    prices: List[ProductPriceInputTypedDict]
    r"""List of available prices for this product."""
    benefits: List[ProductInputBenefitsTypedDict]

...
class BenefitLicenseKeysInputType(str, Enum):
    LICENSE_KEYS = "license_keys"


class BenefitLicenseKeysInputTypedDict(TypedDict):
    created_at: datetime
    ...
    type: BenefitLicenseKeysInputType


class BenefitLicenseKeysInput(BaseModel):
    created_at: datetime
    r"""Creation timestamp of the object."""
    ...
    # fmt: off
    TYPE: Annotated[Final[BenefitLicenseKeysInputType], pydantic.Field(alias="type")] = BenefitLicenseKeysInputType.LICENSE_KEYS # type: ignore
    # fmt: on

...
class AlreadyActiveSubscriptionError(Exception):
    data: AlreadyActiveSubscriptionErrorData

    def __init__(self, data: AlreadyActiveSubscriptionErrorData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, AlreadyActiveSubscriptionErrorData)

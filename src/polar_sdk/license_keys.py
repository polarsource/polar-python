...
class LicenseKeys(BaseSDK):
        ...
        **Scopes**: `license_keys:read` `license_keys:write`
        ...
        if utils.match_response(http_res, "401", "application/json"):
            response_data = utils.unmarshal_json_response(
                models.UnauthorizedData, http_res
            )
        ...
        **Scopes**: `license_keys:read` `license_keys:write`
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(
                models.LicenseKeyWithActivations, http_res
            )
        if utils.match_response(http_res, "401", "application/json"):
            response_data = utils.unmarshal_json_response(
                models.UnauthorizedData, http_res
    ...
    def update(
        ...
        **Scopes**: `license_keys:write`
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(models.LicenseKeyRead, http_res)
        if utils.match_response(http_res, "401", "application/json"):
            response_data = utils.unmarshal_json_response(
                models.UnauthorizedData, http_res
            )
    ...
    def get_activation(
        ...
        **Scopes**: `license_keys:read` `license_keys:write`
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(
                models.LicenseKeyActivationRead, http_res
            )
        if utils.match_response(http_res, "401", "application/json"):
            response_data = utils.unmarshal_json_response(
                models.UnauthorizedData, http_res

...
| `status`                                                                                                                                                                | [OptionalNullable[models.DisputesListQueryParamStatusFilter]](../../models/disputeslistqueryparamstatusfilter.md)                                                       | :heavy_minus_sign:                                                                                                                                                      | Filter by dispute status.                                                                                                                                               |

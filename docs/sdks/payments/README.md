...
| `customer_id`                                                                                                                                                           | [OptionalNullable[models.PaymentsListQueryParamCustomerIDFilter]](../../models/paymentslistqueryparamcustomeridfilter.md)                                               | :heavy_minus_sign:                                                                                                                                                      | Filter by customer ID.                                                                                                                                                  |

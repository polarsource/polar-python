...
| `external_customer_id`                                                                                                                                                  | [OptionalNullable[models.CheckoutsListQueryParamExternalCustomerIDFilter]](../../models/checkoutslistqueryparamexternalcustomeridfilter.md)                             | :heavy_minus_sign:                                                                                                                                                      | Filter by customer external ID.                                                                                                                                         |
| `status`                                                                                                                                                                | [OptionalNullable[models.CheckoutsListQueryParamStatusFilter]](../../models/checkoutslistqueryparamstatusfilter.md)                                                     | :heavy_minus_sign:                                                                                                                                                      | Filter by checkout session status.                                                                                                                                      |

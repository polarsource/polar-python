...
| `parent_id`                                                                                                                                                             | *OptionalNullable[str]*                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                      | Filter events by parent event ID when hierarchical is set to true. When not specified or null, returns root events only.                                                |
| `hierarchical`                                                                                                                                                          | *Optional[bool]*                                                                                                                                                        | :heavy_minus_sign:                                                                                                                                                      | When true, filters by parent_id (root events if not specified). When false, returns all events regardless of hierarchy.                                                 |

...
| `external_customer_id`                                                                                                                                                  | [OptionalNullable[models.RefundsListQueryParamExternalCustomerIDFilter]](../../models/refundslistqueryparamexternalcustomeridfilter.md)                                 | :heavy_minus_sign:                                                                                                                                                      | Filter by customer external ID.                                                                                                                                         |

...
| `account_review_v2_enabled`                                    | *Optional[bool]*                                               | :heavy_minus_sign:                                             | If this organization sees the new account review checklist UI. |
...
| `billing_enabled`                                              | *Optional[bool]*                                               | :heavy_minus_sign:                                             | If this organization has billing enabled                       |